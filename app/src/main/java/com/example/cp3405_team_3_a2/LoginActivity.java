...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper.insertJob("google", "top meme", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme2", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme3", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme4", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme5", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme6", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme7", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme8", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
        databaseHelper.insertJob("google", "top meme9", "you make memes", "computers", "100", "10/11/10",unixTime, "sydney");
